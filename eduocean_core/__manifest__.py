...

{
    ...
    'test': [
        ...
        'test/teacher_emp_user_creation.yml',
    ],
    'css': ['static/src/css/base.css'],
    'qweb': [
        'static/src/xml/base.xml',
        'static/src/xml/dashboard_ext_eduocean.xml'],
    'js': [],
    'images': [
        'static/description/eduocean_core_banner.jpg',
    ],
    'installable': True,
    'auto_install': False,
    'application': True,
